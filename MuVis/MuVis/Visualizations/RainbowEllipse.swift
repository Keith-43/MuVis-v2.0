...
// ---------------------------------------------------------------------------------------------------------------------
            ...
            for ellipseNum in 0 ..< ellipseCount {       //  0 <= ellipseNum < 48
                ...
                let hue: Double = (ellipseNum == ellipseCount-1) ? Double(startHue360) / 360.0 : RainbowEllipse.hueOld[ellipseNum+1]   // 0.0 <= hue < 1.0
                ...
                for oct in 0 ..< octaveCount {     //  0 <= oct < 6
                    ...
                    if(oct==0) {                                // oct=0  theta=0  point=0
                        ...
                        mag = 0.3 * Double(audioManager.muSpecHistory[ellipseOffset])
                    ...
                    for point in 0 ..< pointsPerOctave {    // 12 * 12 = 144 = number of points per octave
                        ...
                        mag = 0.3 * Double(audioManager.muSpecHistory[tempIndex])
