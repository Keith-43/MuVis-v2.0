...
//---------------------------------------------------------------------------------------------------------------------
            for lineNum in 0 ..< lineCount {       //  0 <= lineNum < 48
                ...
                for point in 0 ..< sixOctPointCount{     // 0 <= point < 864
                    ...
                    let mag: Double = 0.3 * Double( audioManager.muSpecHistory[tempIndex] )
                ...
                Waterfall_Live.colorIndex = (Waterfall_Live.colorIndex >= colorSize) ?
                                            0 :
                                            Waterfall_Live.colorIndex + 1
