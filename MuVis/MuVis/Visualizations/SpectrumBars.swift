    ...
    var body: some View {
        ...
        HStack(spacing: 0.0) {
            ForEach( bottomNote ..< topNote, id: \.self ) { note in
                ...
                AmplitudeBar(amplitude: audioManager.muSpectrum[12*note+6],
...
struct AmplitudeBar: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            let duration1: Double = (settings.optionOn == false) ? 0.2 : 2.0
            ...
            ZStack(alignment: .bottom){
                ...
                Rectangle()
                    ...
                    .fill((settings.selectedColorScheme == .light) ? Color.white : Color.black)
    ...
    func addCap(width: CGFloat, height: CGFloat) -> some View {
        ...
        let duration2: Double = (settings.optionOn == false) ? 2.0 : 10.0
